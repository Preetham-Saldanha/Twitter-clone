...
function Tweet({ tweet }: Props) {
  return (
    <div className='flex space-x-2 py-3 border-gray-100 border-b hover:bg-slate-100'>
      <div className=''>
        <img className='h-12 w-14 object-cover rounded-full' src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Placeholder_no_text.svg/768px-Placeholder_no_text.svg.png" alt="" />
      </div>
